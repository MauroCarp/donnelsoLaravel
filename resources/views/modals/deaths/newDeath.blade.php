@extends('modals/modal',['idModal' => 'modalDeath','modalTitle'=>'Nueva Muerte','modalSize'=>'lg'])

@section('modalContent')

<form action="deaths" method="POST" id="newDeadForm" style="margin-bottom:0">
    @csrf        
...
@section('modalFooter')
    ...
    <button class="btn btn-success" type="submit" form="newDeadForm" id="btnNewDead" name="btnNewDead">Cargar Muerte</button>
